...
public class PalindromeFinder {
    public static void main(String[] args) {
        ...
        while (!in.isEmpty()) {
            ...
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(3))) {
                wordsSum.put(3, wordsSum.getOrDefault(3, 0) + 1);
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(4))) {
                wordsSum.put(4, wordsSum.getOrDefault(4, 0) + 1);
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(5))) {
                wordsSum.put(5, wordsSum.getOrDefault(5, 0) + 1);
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(6))) {
                wordsSum.put(6, wordsSum.getOrDefault(6, 0) + 1);
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(7))) {
                wordsSum.put(7, wordsSum.getOrDefault(7, 0) + 1);
            } else if (word.length() >= minLength && palindrome.isPalindrome(word, new OffByN(8))) {
